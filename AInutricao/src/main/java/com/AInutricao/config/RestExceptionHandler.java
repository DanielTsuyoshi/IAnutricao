...
import com.AInutricao.exceptions.RestError;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<RestError> responseStatusExceptionHandler(ResponseStatusException e){
        RestError restError = new RestError(e.getStatusCode().value(), e.getBody().getDetail());
        return ResponseEntity.status(e.getStatusCode()).body(restError);
    }
